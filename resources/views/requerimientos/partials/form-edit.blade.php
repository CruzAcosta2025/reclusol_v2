<div class="relative bg-white rounded-xl shadow-xl max-w-4xl mx-auto p-4">
    {{-- Cabecera --}}
    <div class="flex justify-between items-center border-b pb-2 mb-4">
        <h2 class="text-base font-semibold text-gray-800">Editar Requerimiento</h2>
        <button type="button"
    ...
    <form id="form-edit"
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div>
                ...
                <select id="area_solicitante" name="area_solicitante" required
                    ...
                    <option value="{{ $key }}" {{ old('area_solicitante', $requerimiento->area_solicitante)===$key ? 'selected':'' }}>
                        {{ $label }}
                    </option>
                    @endforeach
                </select>
            ...
            <div>
                ...
                <select id="sucursal" name="sucursal" required
                    ...
                    <option value="{{ $sucursal->SUCU_CODIGO }}" {{ old('sucursal', $requerimiento->sucursal)===$sucursal->SUCU_CODIGO ? 'selected':'' }}>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
                ...
                <select id="nivel_estudios" name="nivel_estudios" required
                    ...
                    <option value="{{ $nivel->NIED_CODIGO}}" {{ old('nivel_estudios', $requerimiento->nivel_estudios)===$nivel->NIED_CODIGO ? 'selected':'' }}>
            ...
            <div>
                <label for="experiencia_minima" class="block font-medium text-gray-700 mb-1">Experiencia Mínima</label>
                <select id="experiencia_minima" name="experiencia_minima" required
                    ...
                    <option value="{{ $key }}" {{ old('experiencia_minima', $requerimiento->experiencia_minima)===$key ? 'selected':'' }}>
                        {{ $label }}
                    </option>
                    @endforeach
                </select>
        ...
        <div>
            <label for="requisitos_adicionales" class="block font-medium text-gray-700 mb-1">Requisitos Adicionales</label>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
                ...
                <select id="prioridad" name="prioridad"
                    ...
                    <option value="{{ $key }}" {{ old('prioridad', $requerimiento->prioridad)===$key ? 'selected':'' }}>
                        {{ $label }}
                    </option>
                    @endforeach
                </select>
            ...
            <div>
                ...
                <select id="estado" name="estado"
                    ...
                    <option value="{{ $estado->id }}" {{ old('estado', $requerimiento->estado)==$estado->id ? 'selected':'' }}>
                        {{ $estado->nombre }}
                    </option>
                    @endforeach
                </select>
