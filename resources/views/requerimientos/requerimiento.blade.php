    ...
    <div class="space-y-6">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-8">
                <div class="card glass-strong p-6 shadow-soft">
                    <div class="flex items-start justify-between gap-4 flex-wrap">
                        <div class="min-w-0">
                            <h1 class="text-xl sm:text-2xl font-extrabold text-white tracking-wide">Nueva Solicitud</h1>
                            <p class="text-sm text-white/70 mt-1">Complete la información para crear una nueva solicitud de
                                personal</p>
                        </div>
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="grid md:grid-cols-2 gap-4">
                                <div class="space-y-2">
                                    ...
                                    <input type="number" id="edad_minima" name="edad_minima" min="18"
                                        max="65"
                                        class="form-input w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition-all duration-300"
                                ...
                                <div class="space-y-2">
                                    ...
                                    <input type="number" id="edad_maxima" name="edad_maxima" min="18"
                                        max="70"
                                        class="form-input w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition-all duration-300"
                            ...
                            <div id="campos-operativo" class="space-y-2" style="display: none;">
                                ...
                                <div class="space-y-2">
                                    ...
                                    <select id="servicio_acuartelado" name="servicio_acuartelado"
                                        ...
                                        <option value="No">No</option>
                                        <option value="Con habitabilidad">Con habitabilidad</option>
                                        <option value="Con alimentación">Con alimentación</option>
                                        <option value="Con movilidad de traslado">Con movilidad de traslado</option>
                                    </select>
                                </div>
                                --}}

                                <div class="space-y-2" x-data="servicioAcuarteladoMultiFix()">
                                    <label class="block text-sm font-semibold text-gray-700">
                                        <i class="fas fa-campground mr-2 text-green-500"></i>
                                        Servicio acuartelado *
                                    </label>
                                    ...
                                    <button type="button" @click="open = !open"
                                        class="w-full px-4 py-3 border border-gray-300 rounded-lg bg-white text-left focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition-all duration-300">
                                        <span x-text="displayText()"
                                            :class="selected.length === 0 ? 'text-gray-400' : 'text-gray-700'"></span>
                                    </button>
                                    ...
                                    <div class="max-h-56 overflow-auto p-2">
                                        <template x-for="opt in options" x-bind:key="opt">
                                            <label
                                                class="flex items-center gap-2 px-3 py-2 rounded-md hover:bg-blue-50 cursor-pointer">
                                                <input type="checkbox" name="servicio_acuartelado[]"
                                                    class="rounded border-gray-300 text-blue-600 focus:ring-blue-500"
                                                    x-bind:value="opt" :checked="isChecked(opt)"
                            ...
                            <div class="space-y-2">
                                ...
                                <select id="grado_academico" name="grado_academico"
                                    ...
                                    <option value="5to Grado de Secundaria">5to Grado de Secundaria</option>
                                    <option value="Egresado de la FFAA/FFPP">Egresado de la FFAA/FFPP</option>
                    ...
                    <div class="grid lg:grid-cols-1 gap-6 ">
                        ...
                        <div class="bg-white rounded-2xl shadow-lg p-8 card-hover">
                            ...
                            <div class="space-y-6">
                                ...
                                <div class="relative">
                                    <span
                                        class="absolute left-3 top-1/2 -translate-y-1/2 text-gray-500 select-none">S/</span>
                                    <input type="number" id="sueldo_basico" name="sueldo_basico" inputmode="decimal"
                                        min="0" step="0.01" placeholder="0.00"
                                        value="{{ old('sueldo_basico') }}" required
                                ...
                                <div class="space-y-2">
                                    ...
                                    <select id="beneficios" name="beneficios" required
                                        ...
                                        <option value="Asignación familiar">Asignación familiar</option>
                                ...
                                <div class="space-y-2" x-data="beneficiosMultiSelect()">
                                    <label class="block text-sm font-semibold text-gray-700">
                                        <i class="fas fa-chart-line mr-2 text-purple-500"></i>
                                        Beneficios adicionales incluidos *
                                    </label>

                                    <!-- Botón / "input" del dropdown -->
                                    <button type="button" @click="open = !open"
                                        class="w-full px-4 py-3 border border-gray-300 rounded-lg bg-white text-left focus:ring-2 focus:ring-purple-500 focus:border-transparent outline-none transition-all duration-300">
                                        <template x-if="selected.length === 0">
                                            <span class="text-gray-400">Selecciona el beneficio</span>
                                        </template>
                                        <template x-if="selected.length > 0">
                                    ...
                                    <div x-show="open" x-transition @click.outside="open = false"
                                        ...
                                        <div class="max-h-56 overflow-auto p-2">
                                            <template x-for="opt in options" :key="opt">
                                                <label
                                                    class="flex items-center gap-2 px-3 py-2 rounded-md hover:bg-purple-50 cursor-pointer">
                                                    <input type="checkbox"
                                        ...
                                        <div class="border-t px-3 py-2 flex items-center justify-between">
                                            ...
                                            <button type="button"
                                                class="text-sm text-purple-600 font-semibold hover:text-purple-700"
                                                @click="open = false">
                                                Listo
                                            </button>
                                        </div>
                                    ...
                                    <!-- Inputs hidden para enviar como array: beneficios[] -->
        ...
        <script>
            ...
            document.addEventListener('DOMContentLoaded', function() {
                ...
                // Si no existen los campos de detalle por sexo, no aplica esta validación
                if (!cantidadRequerida || !cantidadMasculino || !cantidadFemenino) {
                    return;
                }
            ...
            document.addEventListener('DOMContentLoaded', function() {
                ...
                function toggleCamposOperativo() {
                    ...
                    camposOperativo.style.display = esOperativo ? '' : 'none';
                        ...
                        // Evita requerir los checkboxes del multiselect de servicio acuartelado,
                        // ya que están ocultos cuando el dropdown está cerrado.
                        if (el.name === 'servicio_acuartelado[]') {
                            el.required = false;
                            return;
                        }
                        ...
                        if (!esOperativo) {
                            el.value = '';
                            // el.disabled = true; (quitalo cuando esOperativo)
                        } else {
                            // el.disabled = false;
                        }
                    });
            ...
            (function() {
                ...
                if (!clienteSel || !sedeSelect) return;
            ...
            document.addEventListener('alpine:init', () => {
                Alpine.data('beneficiosMultiSelect', () => ({
                    open: false,
                    options: [
                        'Vacaciones',
                        'Utilidades',
            ...
            const initialServicioAcuartelado = @json(old('servicio_acuartelado', []));

            document.addEventListener('alpine:init', () => {
                Alpine.data('servicioAcuarteladoMultiFix', () => {
                    const parsed = Array.isArray(initialServicioAcuartelado) ?
                        initialServicioAcuartelado :
                        (initialServicioAcuartelado ? [initialServicioAcuartelado] : []);
                    ...
                    return {
                        ...
                        toggle(opt, checked) {
                            if (checked) {
                                if (!this.selected.includes(opt)) this.selected.push(opt);
                            } else {
                                this.selected = this.selected.filter(item => item !== opt);
                            }
                        },
                        isChecked(opt) {
                        ...
                        displayText() {
                            return this.selected.length ? this.selected.join(', ') : 'Seleccione el servicio';
                        }
                    };
                });
            });
