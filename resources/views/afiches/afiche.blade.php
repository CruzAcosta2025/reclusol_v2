    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-1 space-y-6">
                ...
                'location' => $req->sucursal_nombre . ' - ' . $req->cliente, // 👈 Cambiado
            ...
            <div class="lg:col-span-2">
                <div class="bg-white rounded-2xl shadow-lg p-6 card-hover">
                    <div class="flex justify-between items-center mb-6">
                        <button id="btn-ver-afiche" class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg mb-3" onclick="verAfiche()">
                            <i class="fas fa-eye"></i> Ver afiche
                        </button>
                        ...
                        <div class="flex flex-col mb-4">
                            <label class="font-bold mb-2">Mensaje predeterminado para publicar:</label>
                            <textarea id="mensaje-predeterminado" class="w-full p-3 rounded-lg border border-gray-300 text-sm bg-gray-50 resize-none" rows="8" readonly></textarea>
                            <button class="bg-purple-600 hover:bg-purple-700 text-white px-4 py-2 rounded-lg mt-2 flex items-center justify-center space-x-2"
                                onclick="copiarMensaje()">
                                <i class="fas fa-copy"></i> <span>Copiar Información</span>
                            </button>
                        </div>
