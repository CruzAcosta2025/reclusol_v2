...
@section('content')
    <div class="min-h-screen bg-gradient-to-br from-cyan-400 via-cyan-900 to-cyan-700 py-8">
        ...
        {{-- Filtros --}}
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-8">
            <form id="filter-form" method="GET" action="{{ route('entrevistas.index') }}" class="grid grid-cols-1 md:grid-cols-3 gap-4 bg-white p-6 rounded-2xl shadow-lg">
                <div>
                ...
                <div class="overflow-x-auto">
                    <table class="w-full">
                        <thead class="bg-gradient-to-r from-blue-50 to-blue-100">
                            <tr class="text-left">
                                <th class="px-6 py-4 text-xs font-bold text-gray-600 uppercase tracking-wider text-center">Nombre completo</th>
                                ...
                                <th class="px-6 py-4 text-xs font-bold text-gray-600 uppercase tracking-wider text-center">Fecha de postulación</th>
                        ...
                        <tbody class="divide-y divide-gray-200">
                            ...
                            <tr class="hover:bg-blue-50 transition-colors"
                                ...
                                <td class="px-6 py-4 text-center">
                                    <span class="text-sm text-gray-900">{{ $postulante->departamento_nombre ?? $postulante->departamento }}</span>
                                </td>
                                <td class="px-6 py-4 text-center">
                                    <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-indigo-100 text-indigo-800">
                                        {{ $postulante->cargo_nombre ?? $postulante->cargo }}
                                    </span>
                                </td>
                                <td class="px-6 py-4 text-center">
                                    <span class="text-sm text-gray-900">{{ \Carbon\Carbon::parse($postulante->fecha_postula)->format('d/m/Y') }}</span>
                                </td>
                                <td class="px-6 py-4">
        ...
        <div id="delete-modal" class="hidden fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
            <div class="bg-white rounded-2xl shadow-2xl max-w-sm w-full mx-4 p-6">
                <div class="text-center">
                    ...
                    <p class="text-sm text-gray-600 mb-6">Esta acción no se puede deshacer. El postulante será eliminado permanentemente.</p>
