                    ...
                    <div class="p-6">
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="p-3 bg-gray-50 rounded-xl border">
                                    <p class="text-sm font-semibold text-gray-900">
                                        {{ $postulante->distrito_nombre ?? $postulante->distrito }}</p>
                                </div>
                            </div>
                            <div class="space-y-2">
                                <label class="text-sm font-medium text-gray-700 flex items-center">
                                ...
                                <div class="p-3 bg-gray-50 rounded-xl border">
                                    <p class="text-sm font-semibold text-gray-900">
                                        {{ $postulante->dni ?? 'No especificado' }}</p>
                                </div>
                            </div>
                            <div class="space-y-2">
                                <label class="text-sm font-medium text-gray-700 flex items-center">
                                ...
                                <div class="p-3 bg-gray-50 rounded-xl border">
                                    <p class="text-sm font-semibold text-gray-900">
                                        {{ $postulante->edad ?? 'No especificado' }}</p>
                                </div>
                            </div>
                            <div class="space-y-2">
                                <label class="text-sm font-medium text-gray-700 flex items-center">
                                ...
                                <div class="p-3 bg-gray-50 rounded-xl border">
                                    <p class="text-sm font-semibold text-gray-900">
                                        {{ $postulante->celular ?? 'No especificado' }}</p>
                                </div>
                            </div>
                            <div class="space-y-2">
                                <label class="text-sm font-medium text-gray-700 flex items-center">
                                ...
                                <div class="p-3 bg-gray-50 rounded-xl border">
                                    <p class="text-sm font-semibold text-gray-900">
                                        {{ \Carbon\Carbon::parse($postulante->fecha_postula)->format('d/m/Y') }}</p>
                                </div>
                            </div>
                            <div class="space-y-2">
                                <label class="text-sm font-medium text-gray-700 flex items-center">
                                ...
                                <div class="p-3 bg-gray-50 rounded-xl border">
                                    <p class="text-sm font-semibold text-gray-900">
                                        {{ $postulante->experiencia_rubro ?? 'No especificado' }}</p>
                                </div>
                            </div>
                            <div class="space-y-2">
                                <label class="text-sm font-medium text-gray-700 flex items-center">
                                ...
                                <div class="p-3 bg-gray-50 rounded-xl border">
                                    <p class="text-sm font-semibold text-gray-900">
                                        {{ $postulante->grado_instruccion ?? 'No especificado' }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
