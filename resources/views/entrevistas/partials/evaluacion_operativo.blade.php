...
@php
// Arrays seleccionados desde BD o desde old()
...
// En la BD guardamos las habilidades en competencias['habilidades']
            ...
            <div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3">
                    <label class="flex items-center p-2 bg-gray-50 rounded-lg border hover:bg-gray-100 cursor-pointer">
                        <input type="checkbox" name="formacion[]" value="Curso SUCAMEC" class="rounded mr-2"
                            {{ in_array('Curso SUCAMEC', $formacionSel, true) ? 'checked' : '' }}>
