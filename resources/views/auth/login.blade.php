...
<div class="min-h-screen gradient-bg flex items-center justify-center p-4 sm:p-0 pt-8 sm:pt-0 relative">
    ...
    <a href="{{ route('welcome') }}" class="hidden sm:flex absolute top-6 left-6 text-white hover:text-yellow-300 transition-colors items-center space-x-2 group z-50">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-12 items-center">
            ...
            <div class="text-white space-y-8 text-center lg:text-left">
                ...
                <div class="block sm:hidden w-full flex justify-start mb-2">
                    <a href="{{ route('welcome') }}" class="flex items-center bg-blue-600 px-4 py-2 rounded-lg text-white hover:text-yellow-300 transition-colors space-x-2 group">
                        <i class="fas fa-arrow-left group-hover:-translate-x-1 transition-transform"></i>
                        <span class="font-medium">Volver al inicio</span>
                    </a>
                </div>
                ...
                <div class="flex justify-center lg:justify-start">
                    <div class="lock-icon w-24 h-24 sm:w-32 sm:h-32 rounded-full flex items-center justify-center floating-animation">
            ...
            <div class="flex justify-center">
                <div class="bg-white rounded-3xl shadow-2xl p-5 sm:p-8 w-full max-w-md slide-in">
                    <div class="text-center mb-6 sm:mb-8">
                        ...
                        <p class="text-gray-600 text-sm sm:text-base">Ingresa tus credenciales para acceder a tu cuenta</p>
                    </div>
                    ...
                    <form method="POST" action="{{ route('login') }}" class="space-y-6" autocomplete="off">
                        ...
                        <!-- Login Button -->
                        <x-primary-button class="btn-primary w-full text-white py-3 rounded-lg font-semibold text-base sm:text-lg flex items-center justify-center space-x-2 transition-all duration-300 hover:shadow-lg hover:-translate-y-1">
