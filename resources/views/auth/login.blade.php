<x-guest-layout>
    <div class="min-h-screen gradient-bg flex items-center justify-center p-4">
        <!-- Back to Home Button -->
        <a href="{{ route('welcome') }}" class="absolute top-6 left-6 text-white hover:text-yellow-300 transition-colors flex items-center space-x-2 group">
            ...
            <div class="grid lg:grid-cols-2 gap-12 items-center">
                ...
                <div class="text-white space-y-8 text-center lg:text-left">
                    <div class="space-y-4">
                        ...
                        <p class="text-xl text-blue-100 leading-relaxed max-w-md mx-auto lg:mx-0">
                    ...
                    <div class="flex justify-center lg:justify-start">
                        <div class="lock-icon w-32 h-32 rounded-full flex items-center justify-center floating-animation">
                    ...
                    <div class="space-y-4 max-w-md mx-auto lg:mx-0">
                        ...
                        <div class="flex items-center space-x-3 text-blue-100">
                            <i class="fas fa-check-circle text-green-400"></i>
                            <span>Miles de oportunidades laborales</span>
                        </div>
                        <div class="flex items-center space-x-3 text-blue-100">
                            <i class="fas fa-check-circle text-green-400"></i>
                            <span>Conecta con empresas líderes</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="flex justify-center">
                    <div class="bg-white rounded-3xl shadow-2xl p-8 w-full max-w-md slide-in">
                        ...
                        <form method="POST" action="{{ route('login') }}" class="space-y-6" autocomplete="off">
                            ...
                            <!-- Login Button -->
                            <x-primary-button class="btn-primary w-full text-white py-3 rounded-lg font-semibold text-lg flex items-center justify-center space-x-2 transition-all duration-300 hover:shadow-lg hover:-translate-y-1">
