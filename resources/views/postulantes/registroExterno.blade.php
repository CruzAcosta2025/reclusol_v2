    ...
    <div class="font-sans antialiased">
        <div class="min-h-screen gradient-bg py-5 sm:py-8 relative">
            ...
            <div class="block sm:hidden mb-4">
                <a href="{{ route('welcome') }}" class="flex items-center w-max m1-2 bg-blue-600 px-2 py-2 rounded-lg text-white hover:text-yellow-300 transition-colors space-x-4 group">
                    <i class="fas fa-arrow-left group-hover:-translate-x-1 transition-transform"></i>
                    <span class="font-medium">Volver al inicio</span>
                </a>
            </div>
            <!-- Volver solo escritorio -->
            <a href="{{ route('welcome') }}" class="hidden sm:flex absolute top-6 left-6 text-white hover:text-yellow-300 transition-colors items-center space-x-2 group z-10">
                <i class="fas fa-arrow-left group-hover:-translate-x-1 transition-transform"></i>
                <span class="font-medium">Volver al inicio</span>
            </a>
            ...
            <div class="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8 mb-6">
                <div class="text-center text-white">
                    ...
                    <p class="text-base sm:text-xl text-blue-100">Completa todos los campos para enviar tu postulación</p>
                </div>
            </div>
            ...
            <div class="max-w-4xl mx-auto px-2 sm:px-6 lg:px-8 mb-6">
                ...
                <div class="flex flex-col sm:flex-row justify-between mt-2 text-xs sm:text-sm text-white text-center sm:text-left gap-1 sm:gap-0">
        ...
        <div class="bg-red-100 text-red-800 p-4 rounded mb-6">
          ...
          @endif -->
            ...
            <form method="POST" action="{{ route('postulantes.storeExterno') }}" enctype="multipart/form-data" class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" id="postulanteForm">
                @csrf
                ...
                <div id="step-1" class="form-step">
                    <div class="bg-white rounded-3xl shadow-2xl p-8 mb-8">
                        ...
                        <div class="grid md:grid-cols-2 gap-6">
                            ...
                            <div class="space-y-2">
                                <label for="celular_referencia" class="block text-xs sm:text-sm font-semibold text-gray-700">
                ...
                <div id="step-2" class="form-step hidden">
                    <div class="bg-white rounded-3xl shadow-2xl p-8 mb-8">
                        ...
                        <div class="grid md:grid-cols-2 gap-6">
                            ...
                            <div class="space-y-2">
                                <label for="experiencia_rubro" class="block text-xs sm:text-sm font-semibold text-gray-700">
                            ...
                            <div class="space-y-2">
                                <label for="grado_instruccion" class="block text-xs sm:text-sm font-semibold text-gray-700">
                            ...
                            <!-- Servicio militar -->
                            <div class="space-y-2">
                                <label for="servicio_militar" class="block text-xs sm:text-sm font-semibold text-gray-700">
