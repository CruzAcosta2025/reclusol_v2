        ...
        <div class="card glass-strong p-6 shadow-soft">
            <div class="flex items-start justify-between gap-4 flex-wrap">
                <div class="min-w-0">
                    ...
                    <p class="text-sm text-white/70 mt-1">Gestiona y supervisa todos los postulantes de manera eficiente</p>
                </div>
...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-8 mt-6">
    ...
    <div id="validar-modal"
        ...
        <div
            class="panel-light text-gray-900 p-6 rounded-2xl w-full max-w-md shadow-2xl border border-gray-100 mx-4
               focus:outline-none focus-visible:ring focus-visible:ring-emerald-200">

            <!-- Encabezado -->
            <h3 id="validar-title" class="text-lg font-semibold text-gray-900 mb-4 flex items-center gap-2">
                <i class="fa-solid fa-clipboard-check text-emerald-600"></i>
                <span class="text-gray-900">Validar:</span>
                <span id="val-nombre" class="font-normal text-gray-700"></span>
            </h3>

            <p id="validar-desc" class="text-sm text-gray-600 mb-3">
            ...
            <form id="form-validar" method="POST" class="space-y-4" autocomplete="off">
                ...
                <fieldset class="space-y-2">
                    ...
                    <label class="flex items-center gap-2 p-2 rounded-lg border hover:bg-gray-50 cursor-pointer transition">
