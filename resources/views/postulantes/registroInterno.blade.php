                    ...
                    <div class="grid md:grid-cols-2 gap-8">
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="border-2 border-dashed border-gray-300 rounded-lg p-8 text-center hover:border-purple-400 transition-colors">
                                <input type="file" id="cv" name="cv" accept=".pdf" data-max=5 class="hidden" onchange="handleFileUpload(this, 'cv-preview')">
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="border-2 border-dashed border-gray-300 rounded-lg p-8 text-center hover:border-purple-400 transition-colors">
                                <input type="file" id="cul" name="cul" accept=".pdf" data-max=5 class="hidden" onchange="handleFileUpload(this, 'cul-preview')">
